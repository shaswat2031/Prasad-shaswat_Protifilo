...
function Sidebar({ closeSidebar }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-8">
        ...
        <div className="relative rounded-full p-1 overflow-hidden">
          <img
            ...
            className={`rounded-full w-36 h-36 object-cover border-4 ${
              darkMode ? "border-indigo-400" : "border-white"
            } shadow-lg transform`}
          />
        </div>
        ...
        <div
          className={`absolute -top-2 -right-2 ${
            darkMode ? "text-blue-300" : "text-yellow-300"
          } opacity-70`}
        >
          <FaCode size={16} />
        </div>
        ...
        <div
          className={`absolute -bottom-2 -left-2 ${
            darkMode ? "text-purple-300" : "text-yellow-300"
          } opacity-70`}
        >
          <FaCode size={14} />
        </div>
      ...
      <div
        className={`${
          darkMode ? "text-indigo-200" : "text-orange-200"
        } text-sm mb-4 px-4 text-center`}
      >
      ...
      <div className="flex space-x-3 mb-6">
        ...
        >
          <FaLinkedin size={16} />
          <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-20 text-center text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none bg-black bg-opacity-70 px-2 py-1 rounded">
            LinkedIn
          </span>
        </a>
      ...
      <div className="w-full px-6 mb-6 relative">
        ...
        >
          <div
            className={`absolute top-1/2 left-1/4 -translate-y-1/2 w-2 h-2 ${
              darkMode ? "bg-indigo-300" : "bg-yellow-300"
            } rounded-full`}
          />
          <div
            className={`absolute top-1/2 left-3/4 -translate-y-1/2 w-1.5 h-1.5 ${
              darkMode ? "bg-blue-300" : "bg-orange-300"
            } rounded-full`}
          />
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="mt-auto pt-4 w-full px-6"></div>
    </div>
  );
}
